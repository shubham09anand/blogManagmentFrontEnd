               ...
               {loadProfile ?
                    ...
                    <div className='border-l-2 border-b-2 w-full lg:block lg:w-1/3 bg-gray-50 lg:h-screen lg:fixed right-0'>
                         <div className="bg-white p-3">
                                        ...
                                        {userProfile?.userName === "@shubham" && (
                                             <>
                                                  ...
                                                  <div className='flex'>
                                                       ...
                                                       <a href="https://shubham09anand.vercel.app/" target='_'>
                              ...
                              <ul className="bg-gray-100 text-black hover:shadow py-2 px-3 active:scale-90 duration-200 mt-3 divide-y rounded shadow-sm">
                              ...
                              {userProfile?.phone.length > 0 &&
                                   (
                                        <ul className="bg-gray-100 text-black hover:shadow py-2 px-3 active:scale-90 duration-200 divide-y rounded shadow-sm">
                                             <li className="flex items-center py-3">
                                                  <div className='flex place-content-center items-center space-x-3'>
