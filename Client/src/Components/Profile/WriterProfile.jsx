                                             ...
                                             <div className='flex items-center'>
                                                  ...
                                                  <div className="flex place-content-center items-center relative px-4 border-opacity-0 hover:border-opacity-100 duration-200 cursor-pointer">
                                                       <div className={`shadow-[1px_1px_1px_black] mr-4 text-center flex place-content-center border-r-2 ${showDelete === key ? 'flex' : 'hidden'}`}>
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="white" className="size-6 my-auto bg-red-600 mr-4 rounded-sm">
                                                       ...
                                                       <div name="showDelete" className='flex place-content-center items-center font-thin space-x-4 sm:text-lg'>
                    ...
                    <div className="bg-white p-3">
                         <div className='flex gap-x-5 place-content-center items-center mb-5'>
                              ...
                              <div>
                                   ...
                                   <h3 className="text-gray-900 font-lg text-semibold leading-6 capitalize">{userProfile?.pronouns}</h3>
                              </div>
                         </div>
                         ...
                         <ul className="bg-gray-100 text-black hover:shadow py-2 px-3 hover:scale-90 duration-200 divide-y rounded shadow-sm">
                              <li className="flex items-center py-3">
                                   ...
                                   <span className="ml-auto font-semibold text-black">{userProfile?.phone}</span>
                              </li>
                         </ul>
                         <ul className="bg-gray-100 text-black hover:shadow py-2 px-3 hover:scale-90 duration-200 divide-y rounded shadow-sm">
                              <li className="flex items-center py-3">
                                   ...
                                   <span className="ml-auto font-semibold text-black">{userProfile?.email}</span>
                              </li>
                         </ul>
                         <ul className="bg-gray-100 text-black hover:shadow py-2 px-3 hover:scale-90 duration-200 divide-y rounded shadow-sm">
                              <li className="flex items-center py-3">
