...
const Header = () => {
     const userId = "66b744f9e4555b39ea4e122e"
     return (
          <header className="header sticky top-0  z-20 bg-[#f7f4ed] shadow-md flex items-center justify-between px-4 md:px-8">
               <div className='text-4xl font-bold tracking-tighter font'>Insider</div>
               ...
               <nav className="nav font-bold text-black text-sm">
                    <ul className="flex items-center">
                         ...
                         <li className="p-4 border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500 duration-200 cursor-pointer active">
                              <Link to='/setting' className='flex place-content-center items-center font-thin space-x-4 sm:text-lg'>
                         ...
                         <li className="p-4 border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500 duration-200 cursor-pointer">
                              <Link to={`/profile/${userId}`}>
                                   <img className="w-10 h-10 rounded-full opacity-100" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Rounded avatar" />
                              </Link>
                         </li>
                    </ul>
               </nav>
