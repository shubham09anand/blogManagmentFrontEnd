...
const EditBlog = () => {
     ...
     return (
          <div className='w-screen bg-[#f7f4ed]'>
               <div className='p-2 w-full md:w-3/5 mx-auto py-5'>
                    <ToastContainer />
                    <div className="mb-5">

                         <input type="text" name="name" id="name" placeholder="Title" className="w-full fontTitle border-b border-slate-300 bg-[#f7f4ed] py-2 px-6 pl-3 text-4xl font-medium outline-none focus:border-[#16831f] focus:shadow-md placeholder:tracking-wider" />
