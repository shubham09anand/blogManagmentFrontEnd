...
const LoadFilterBlog = () => {
     return (

          <div role="status" className="w-11/12 lg:w-1/5 p-4 border border-gray-200 rounded shadow animate-pulse md:p-6">
               ...
               <div className='animate-pulse flex items-center mb-2 pl-2 sm:pl-4 lg:pl-0 pb-2'>
                    <svg className="w-10 h-10 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
               ...
               <div className="h-5 bg-gray-200 rounded-sm w-full mb-4"></div>
               <div className="h-2 bg-gray-200 rounded-sm mb-2.5"></div>
               <div className="h-2 bg-gray-200 rounded-sm mb-2.5"></div>
