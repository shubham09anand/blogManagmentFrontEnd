    ...
    <div className="flex flex-col items-center pt-20 min-h-screen bg-white">
      <div className="flex flex-col">
        <div className="flex flex-col items-center">
          ...
          <div className="font-bold text-3xl xl:text-6xl lg:text-6xl md:text-5xl">
        ...
        <div className="flex flex-col mt-10">
          <div className="flex flex-col items-stretch">
            ...
            <div className="flex flex-row group px-4 py-8 border-t hover:cursor-pointer transition-all duration-200 delay-100" onClick={() => navigate(-1)}>
              <div className="rounded-xl flex place-content-center items-center w-16 h-16 px-3 bg-[#16831f] py-2 md:py-4">
