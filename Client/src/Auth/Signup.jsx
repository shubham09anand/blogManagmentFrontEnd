...
const Signup = () => {
     return (
          <div class="h-screen overflow-y-hidden md:flex bg-[#f7f4ed]">
               <div class="flex md:w-1/2 justify-center mt-20">
                    <form class="w-3/4">
                         ...
                         <div class="flex items-center border-2 py-2 px-3 rounded-md mb-4 bg-white">
                              ...
                              <input class="pl-2 outline-none border-none bg-transparent" type="text" name="" id="" placeholder="Full name" />
                         </div>
                         <div class="flex items-center border-2 py-2 px-3 rounded-md mb-4 bg-white">
                         ...
                         <div class="flex items-center border-2 py-2 px-3 rounded-md mb-4 bg-white">
                              ...
                              <input class="pl-2 outline-none border-none bg-transparent" type="text" name="" id="" placeholder="Email Address" />
                         </div>
